...
public class LogWriter {
    ...
    static LogWriter combine(LogWriter... writers) {
        return new Combined(writers);
    }

    static LogWriter forFile(File f) throws IOException {
    ...
    static class Combined extends LogWriter {
    ...
    static class FileWriter extends LogWriter {
    ...
    static class AsyncLogWriter extends LogWriter {
